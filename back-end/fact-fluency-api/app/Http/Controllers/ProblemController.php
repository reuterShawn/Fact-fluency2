    ...
    public function generate(Request $request)
{
    $validated = $request->validate([
        'operations' => 'required|array|min:1', // Changed to array
        'operations.*' => 'in:addition,subtraction,multiplication,division',
    ...
    for ($i = 0; $i < $validated['count']; $i++) {
        // Pick random operation from selected ones
...
// Keep the existing generateSingleProblem method unchanged
